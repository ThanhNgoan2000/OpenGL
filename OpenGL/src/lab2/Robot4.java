...
public class Robot4 extends GLCanvas {
	...
	private void makeimg() throws IOException {
		...
		mimg1 = ImageIO.read(new File("image/bottom.jpg"));
		mimg2 = ImageIO.read(new File("image/centter.jpg"));
		mimg3 = ImageIO.read(new File("image/left.jpg"));
		mimg4 = ImageIO.read(new File("image/right.jpg"));
		mimg5 = ImageIO.read(new File("image/top.jpg"));
	...
	public void robot2() {
		...
		myGL.glRotatef(0, 0f, 1f, 0f);
		myGL.glRotatef(0, 0f, 0f, 1f);
	...
	public void myReshape(int w, int h) {
		...
		myGL.glLoadIdentity();
		myGLU.gluPerspective(60.0, 1.0 * w / h, 1.0, 30.0);
