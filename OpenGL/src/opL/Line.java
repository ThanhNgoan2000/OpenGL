...
Mọi người
Tất cả chủ đề
Bài 2 - Hình học cơ bản trong đồ hoạ
Bài 1 - Giới Thiệu
Lịch Google
Thư mục Drive của lớp học
Bài 2 - Hình học cơ bản trong đồ hoạ
Bài 2 - Hình học cơ bản trong đồ hoạ
Tài liệu
1. Hình học cơ bản - Lý Thuyết
Đã đăng vào 23 thg 3
Hình học cơ bản
...
Java
Bài tập
2. Hình học cơ bản - Thực hành
Không có ngày đến hạn
Bài 1 - Giới Thiệu
Bài 1 - Giới Thiệu
Tài liệu
1. Giới thiệu - Lý thuyết
Đã đăng vào 17 thg 3
Tài liệu
2. Giới thiệu - Thực hành
Đã đăng vào 17 thg 3
Đã mở rộng 1. Hình học cơ bản - Lý Thuyết*/
/*
 *  lines.java
...
public class Line extends GLCanvas {
	...
	static public void main(String args[]) throws IOException {
		...
		mainFrame.setSize(458, 277);
		Line mainCanvas = new Line();
		mainCanvas.init();
		mainFrame.add(mainCanvas);
		mainFrame.setVisible(true);
	}
//	lines.java
//	Đang hiển thị lines.java.
}
